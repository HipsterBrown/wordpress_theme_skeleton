<?php get_header(); ?>
	...
	<?php rewind_posts(); while (have_posts()) : the_post(); ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<span class="author"><?php _e( 'Published by', 'custom' ); ?> <?php the_author_posts_link(); ?></span>
			<span class="comments"><?php comments_popup_link( __( 'Leave your thoughts', 'custom' ), __( '1 Comment', 'custom' ), __( '% Comments', 'custom' )); ?></span>
			<!-- /post details -->
